  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-border bg-card/40 lg:flex">
      <div className="flex items-center gap-3 border-b border-border px-5 py-4">
        <QbtecLogo className="h-10" />
        <div className="leading-tight">
          <div className="text-base font-bold tracking-tight">
            QB<span className="text-primary">tec</span>
          </div>
          <div className="text-[11px] text-muted-foreground">Operations Intelligence</div>
        </div>
      </div>
      ...
      <div className="space-y-3 border-t border-border px-4 py-4 text-[11px] text-muted-foreground">
        <div className="flex items-start gap-2 rounded-lg border border-primary/20 bg-primary/5 p-2.5">
          ...
          <span>
            <span className="font-medium text-foreground">Maatwerk fabriek</span> — elke order is uniek.
            8 merken · 24/7 service.
          </span>
        </div>
        <div className="flex items-center gap-2">
          <ShieldCheck className="h-3.5 w-3.5 text-success" />
          <span>v1.0 · QBtec B.V. Woerden</span>
        </div>
      </div>
    </aside>
  );
